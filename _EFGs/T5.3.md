...
{% capture map_det %}
The distribution of Sclerophyll hot deserts and semi-deserts in Australia was compiled from multiple source maps (Keith and Tozer 2017). It was mapped at 30 arc second spatial resolution.
{% endcapture %}
{% include MAP.html %}
