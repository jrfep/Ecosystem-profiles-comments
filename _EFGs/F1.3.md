...
{% capture map_det %}
The distribution of freeze-thaw rivers and streams was mapped from the Global River Classification database (Ouellet Dallaire et al. 2018), including all reaches with with minimum temperature below 0°C. Occurrences were aggregated to ten minute spatial resolution.
{% endcapture %}
{% include MAP.html %}
