...
{% capture map_det %} Ecoregions with major and minor occurrences of Shellfish beds and reefs were identified by overlaying a global map of oyster reefs (Beck et al. 2011) on marine ecoregions (Spalding et al. 2008), and then clipping to the extent of the marine ‘shelf’ base layer as mapped by Harris et al. (2014). {% endcapture %}
{% include MAP.html %}
...
* Beck MW, Brumbaugh RD, Airoldi L, Carranza A, Coen LD, Crawford C, Defeo O, Edgar GJ, Hancock B, Kay MC, Lenihan HS (2011) Oyster reefs at risk and recommendations for conservation, restoration and management. Bioscience 61:107-116.
